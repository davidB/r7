define(
  ['r7/Ring', 'r7/Stage4UserInput', 'r7/Stage4Layer2D', 'r7/Stage4Render', 'r7/Stage4DatGui', 'r7/Stage4Animation'],
  (Ring,      Stage4UserInput,      Stage4Layer2D,      Stage4Render,      Stage4DatGui,      Stage4Animation) ->
    (container) -> Ring([
